...
<body>
	...
	<div class="row" >
	<div class="col-lg-5" >
        <?php echo form_open('procurementpage/index'); ?>
                            <br/>
    ...
    <script>
        ...
        function new_announcement(){
            window.location = "<?php echo base_url(); ?>index.php/procurementpage/new_announcement/" + "procurementpage";
        }
        ...
        function delete_announcement(i){
            ...
            if (k){
                window.location = "<?php echo base_url(); ?>index.php/procurementpage/delete_announcement/" + i;
            }
        }
    </script>
</body>
