...
<body>
	...
	<div class="row" >
		<div class="col-lg-5" >
        <?php echo form_open('majorincidentaccidentreportingpage/index'); ?>
        <br/>
    ...
    function new_announcement(){
        window.location = "<?php echo base_url(); ?>index.php/majorincidentaccidentreportingpage/new_announcement/" + "majorincident";
    }
    ...
    function delete_announcement(i){
        ...
        if (k){
            window.location = "<?php echo base_url(); ?>index.php/majorincidentaccidentreportingpage/delete_announcement/" + i;
        }
    }
</script>
</body>
