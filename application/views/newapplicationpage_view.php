...
<body>
    ...
    function new_announcement(){
        window.location = "<?php echo base_url(); ?>index.php/newapplicationpage/new_announcement/" + "newapplicationpage";
    }
    ...
    function delete_announcement(i){
        ...
        if (k){
            window.location = "<?php echo base_url(); ?>index.php/newapplicationpage/delete_announcement/" + i;
        }
    }
   </script>
</body>
