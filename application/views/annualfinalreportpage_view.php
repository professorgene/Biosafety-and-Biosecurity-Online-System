...
<body>
    ...
    <script>
        ...
        function new_announcement(){
            window.location = "<?php echo base_url(); ?>index.php/annualfinalreportpage/new_announcement/" + "annualfinal";
        }
        ...
        function delete_announcement(i){
            ...
            if (k){
            window.location = "<?php echo base_url(); ?>index.php/annualfinalreportpage/delete_announcement/" + i;
            }
        }
</script>
</body>
