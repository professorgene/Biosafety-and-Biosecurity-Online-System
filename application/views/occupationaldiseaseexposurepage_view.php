...
<body>
    ...
    function new_announcement(){
        window.location = "<?php echo base_url(); ?>index.php/occupationaldiseaseexposurepage/new_announcement/" + "occupation";
    }
    ...
    function delete_announcement(i){
        ...
        if (k){
            window.location = "<?php echo base_url(); ?>index.php/occupationaldiseaseexposurepage/delete_announcement/" + i;
        }
    }
</script>
