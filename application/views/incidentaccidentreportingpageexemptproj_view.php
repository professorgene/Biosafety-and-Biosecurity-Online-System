    ...
    <div class="container">
		...
		<div id='breadcrumb1'><?php echo $this->breadcrumbs->show(); ?></div>
			...
			<br>
                ...
                <?php if(isset($editload)) { echo form_open('incidentaccidentreportingpageexemptproj/update_form'); } elseif(isset($saveload)) {echo form_open('incidentaccidentreportingpageexemptproj/continue');} else { echo form_open('incidentaccidentreportingpageexemptproj/index'); } ?>
