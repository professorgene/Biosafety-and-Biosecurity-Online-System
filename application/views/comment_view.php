...
<body>
    ...
    if(isset($load) && $comment_info != null){
        ...
        <div class="row">
            ...
            <div class="col-md-10 bg-white">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="annex2_comment" ><?php if(isset($load) && $comment_info != null){echo set_value('annex2_comment', $comment->annex2_comment);}else{echo set_value('annex2_comment');} ?></textarea>
                    
                </div>
                
                <div class="form-group">
                    <label for="forme_comment">Form E Comments</label>
                    <textarea class="form-control" name="forme_comment" ><?php if(isset($load) && $comment_info != null){echo set_value('forme_comment', $comment->forme_comment);}else{echo set_value('forme_comment');} ?></textarea>
                </div>
                
                <div class="form-group">
                    <label for="pc1_comment">PC 1 Comments</label>
                    <textarea class="form-control" name="pc1_comment" ><?php if(isset($load) && $comment_info != null){echo set_value('pc1_comment', $comment->pc1_comment);}else{echo set_value('pc1_comment');} ?></textarea>
                </div>
                
                <div class="form-group">
                    <label for="pc2_comment">PC 2 Comments</label>
                    <textarea class="form-control" name="pc2_comment" ><?php if(isset($load) && $comment_info != null){echo set_value('pc2_comment', $comment->pc2_comment);}else{echo set_value('pc2_comment');} ?></textarea>
                </div>
                <?php } ?>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="biohazard_comment" ><?php if(isset($load) && $comment_info != null){echo set_value('biohazard_comment', $comment->biohazard_comment);}else{echo set_value('biohazard_comment');} ?></textarea>
                </div>
                <?php } ?>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="exempt_comment" ><?php if(isset($load) && $comment_info != null){echo set_value('exempt_comment', $comment->exempt_comment);}else{echo set_value('exempt_comment');} ?></textarea>
                </div>
                <?php } ?>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="hirarc_comment" ><?php if(isset($load) && $comment_info != null){echo set_value('hirarc_comment', $comment->hirarc_comment);}else{echo set_value('hirarc_comment');} ?></textarea>
                </div>
                
                <div class="form-group">
                    <label for="swp_comment">SWP Comments</label>
                    <textarea class="form-control" name="swp_comment" ><?php if(isset($load) && $comment_info != null){echo set_value('swp_comment', $comment->swp_comment);}else{echo set_value('swp_comment');} ?></textarea>
                </div>
                <?php } ?>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="procurement_comment" ><?php if(isset($load) && $comment_info != null){echo set_value('procurement_comment', $comment->procurement_comment);}else{echo set_value('procurement_comment');} ?></textarea>
                </div>
                <?php } ?>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="notif_of_LMO_BM_comment" ><?php if(isset($load) && $comment_info != null){echo set_value('notif_of_LMO_BM_comment', $comment->notif_of_LMO_BM_comment);}else{echo set_value('notif_of_LMO_BM_comment');} ?></textarea>
                </div>
                <?php } ?>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="notif_of_export_bio_comment" ><?php if(isset($load) && $comment_info != null){echo set_value('notif_of_export_bio_comment', $comment->notif_of_export_bio_comment);}else{echo set_value('notif_of_export_bio_comment');} ?></textarea>
                </div>
                <?php } ?>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="formf_comment" ><?php if(isset($load) && $comment_info != null){echo set_value('formf_comment', $comment->formf_comment);}else{echo set_value('formf_comment');} ?></textarea>
                </div>
                <?php } ?>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="annex3_comment" ><?php if(isset($load) && $comment_info != null){echo set_value('annex3_comment', $comment->annex3_comment);}else{echo set_value('annex3_comment');} ?></textarea>
                </div>
                <?php } ?>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="annex4_comment" ><?php if(isset($load) && $comment_info != null){echo set_value('annex4_comment', $comment->annex4_comment);}else{echo set_value('annex4_comment');} ?></textarea>
                </div>
                <?php } ?>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="incident_accident_comment" ><?php if(isset($load) && $comment_info != null){echo set_value('incident_accident_comment', $comment->incident_accident_comment);}else{echo set_value('incident_accident_comment');} ?></textarea>
                </div>
                <?php } ?>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="annual_report_comment" ><?php if(isset($load) && $comment_info != null){echo set_value('annual_report_comment', $comment->annual_report_comment);}else{echo set_value('annual_report_comment');} ?></textarea>
                </div>
                <?php } ?>
                ...
                <?php if($this->session->userdata('account_type') != 1){ ?>
                    ...
                    <div class="form-group">
                        ...
                        <select <?php if(isset($load)){if($this->session->userdata('account_type') != 2){ echo "disabled"; }} else { echo "disabled"; } ?> class="form-control" name="no_of_ssbc" >
