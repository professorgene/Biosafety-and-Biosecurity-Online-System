...
<body>
    ...
    function new_announcement(){
        window.location = "<?php echo base_url(); ?>index.php/minorbiopage/new_announcement/" + "minorbiopage";
    }
    ...
    function delete_announcement(i){
        ...
        if (k){
            window.location = "<?php echo base_url(); ?>index.php/minorbiopage/delete_announcement/" + i;
        }
    }
</script>
</body>
