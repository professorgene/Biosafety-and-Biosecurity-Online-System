    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <?php if(isset($editload)) { echo form_open('biohazardproj/update_form'); } elseif(isset($saveload)) {echo form_open('biohazardproj/continue');} else { echo form_open('biohazardproj/index'); } ?>
