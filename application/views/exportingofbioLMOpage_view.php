...
<body>
    ...
    <script>
        ...
        function new_announcement(){
            window.location = "<?php echo base_url(); ?>index.php/exportingofbioLMOpage/new_announcement/" + "exportBioLmo";
        }
        ...
        function delete_announcement(i){
            ...
            if (k){
                window.location = "<?php echo base_url(); ?>index.php/exportingofbioLMOpage/delete_announcement/" + i;
            }
        }
        function hard_reset() {
