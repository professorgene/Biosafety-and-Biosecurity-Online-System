...
<body>
	...
	<div class="row" >
	<div class="col-lg-5" >
        <?php echo form_open('exportingofbioLMOpage/index'); ?>
                            <br/>
		...
		<?php if(isset($product_list)) { ?>		
			<div>		
				...
				<a href="<?php echo base_url(); ?>index.php/exportingofbioLMOpage/edit" class="col-md-3"><button class="btn btn-primary button_right">Edit</button></a>	
				<?php }else{ ?>
				 
				 <?php } ?>
			<?php } else { ?>
				
				 <?php echo form_open('exportingofbioLMOpage/save_edit') ?>
			...
			<div class="card my-4">
				...
				<a href="<?php echo base_url(); ?>index.php/exportingofbioLMOpage/save_edit" class="col-md-3"><button class="btn btn-primary button_right">Save</button></a>
				<?php echo form_close(); ?>
			<?php } ?>
		</div>
	</div>					
