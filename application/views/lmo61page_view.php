...
<body>
    ...
    function new_announcement(){
        window.location = "<?php echo base_url(); ?>index.php/lmo61page/new_announcement/" + "lmo61page";
    }
    ...
    function delete_announcement(i){
        ...
        if (k){
            window.location = "<?php echo base_url(); ?>index.php/lmo61page/delete_announcement/" + i;
        }
    }
</script>
</body>
