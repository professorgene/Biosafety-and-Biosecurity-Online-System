...
defined('BASEPATH') OR exit('No direct script access allowed');
    ...
    function __construct()
    {
        ...
        $data['announcement'] = $this->announcement_model->get_all_announcement( 'exportbiomaterial' );
    ...
    public function delete_announcement($id) {
        ...
        $data['announcement'] = $this->announcement_model->remove_announcement($id, 'exportbiomaterial' );
        # change the value inside ( ' HERE ' ) to call different announcement for different pages
        $data['announcement'] = $this->announcement_model->get_all_announcement( 'exportbiomaterial' );
