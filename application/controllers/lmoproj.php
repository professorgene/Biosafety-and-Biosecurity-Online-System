...
defined('BASEPATH') OR exit('No direct script access allowed');
    ...
    function __construct()
    {
        ...
        public function continue(){
            ...
            $applicantFile = $this->input->post('app_file');
            ...
            if($this->form_validation->run() == FALSE){
                ...
                if(isset($save)){
                    ...
                    $this->load->library('upload'); //initialize
                    $this->upload->initialize($config); //Alternately you can set preferences by calling the initialize function. Useful if you auto-
