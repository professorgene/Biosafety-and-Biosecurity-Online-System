...
class procurementpage extends CI_Controller {
	...
	function __construct()
    {
        ...
        $data['announcement'] = $this->announcement_model->get_all_announcement( 'procurementpage' );
    ...
    public function delete_announcement($id) {
        ...
        $data['announcement'] = $this->announcement_model->remove_announcement($id, 'procurementpage' );
        # change the value inside ( ' HERE ' ) to call different announcement for different pages
        $data['announcement'] = $this->announcement_model->get_all_announcement( 'procurementpage' );
