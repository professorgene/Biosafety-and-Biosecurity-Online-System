    ...
    function __construct()
    {
		...
		public function index(){
            ...
            if (!isset($save) && !isset($submit)){
                ...
                if($this->exempt_model->insert_new_applicant_data($exemptData) && $this->hirarc_model->insert_new_applicant_data($hirarcData) && $this->swp_model->insert_new_applicant_data($swpData))
                {
