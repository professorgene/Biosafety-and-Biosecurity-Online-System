...
class editrequest_approval extends CI_Controller {
    ...
    public function reject($id, $appid)
    {
        ...
        $this->email_model->send_email($result[0]->account_email, "Edit Request For New Application For LMO Project Rejected", "<p>Dear ". $result[0]->account_fullname .", <br/><br/>Your Request For Editing An Application For LMO Project Has Been Rejected Due to The Following Reason(s): " . $msg . "</p>");
    ...
    public function approve_bio($id, $appid)
    {
        ...
        $this->email_model->send_email($result[0]->account_email, "Edit Request For Application for Biohazardous Materials Approved", "<p>Dear ". $result[0]->account_fullname .", <br/><br/>Your Request For Editing An Application for Biohazardous Materials Has Been Approved. </p>");
    ...
    public function reject_bio($id, $appid)
    {
        ...
        $this->email_model->send_email($result[0]->account_email, "Edit Request For Application for Biohazardous Materials Rejected", "<p>Dear ". $result[0]->account_fullname .", <br/><br/>Your Request For Editing An Application for Biohazardous Materials Has Been Rejected Due to The Following Reason(s): " . $msg . "</p>");
    ...
    public function approve_exempt($id, $appid)
    {
        ...
        $this->email_model->send_email($result[0]->account_email, "Edit Request For Application for Exempt Dealing Approved", "<p>Dear ". $result[0]->account_fullname .", <br/><br/>Your Request For Editing An Application for Exempt Dealing Has Been Approved. </p>");
    ...
    public function reject_exempt($id, $appid)
    {
        ...
        $this->email_model->send_email($result[0]->account_email, "Edit Request For Application for Exempt Dealing", "<p>Dear ". $result[0]->account_fullname .", <br/><br/>Your Request For Editing An AApplication for Exempt Dealing Has Been Rejected Due to The Following Reason(s): " . $msg . "</p>");
    ...
    public function reject_procurement($id, $appid)
    {
        ...
        $this->email_model->send_email($result[0]->account_email, "Edit Request For Pre-purchase Material Risk Assessment Project Rejected", "<p>Dear ". $result[0]->account_fullname .", <br/><br/>Your Request For Editing Pre-purchase Material Risk Assessment Project Has Been Rejected Due to The Following Reason(s): " . $msg . "</p>");
    ...
    public function approve_notif_LMO($id, $appid)
    {
        ...
        $this->email_model->send_email($result[0]->account_email, "Edit Request For Notification of LMO and BM Project Approved", "<p>Dear ". $result[0]->account_fullname .", <br/><br/>Your Request For Editing A Notification of LMO and BM Project Has Been Approved. </p>");
    ...
    public function reject_notif_LMO($id, $appid)
    {
        ...
        $this->email_model->send_email($result[0]->account_email, "Edit Request For Notification of LMO and BM Project Rejected", "<p>Dear ". $result[0]->account_fullname .", <br/><br/>Your Request For Editing Notification of LMO and BM Project Has Been Rejected Due to The Following Reason(s): " . $msg . "</p>");
    ...
    public function approve_annual($id, $appid)
    {
        ...
        $this->email_model->send_email($result[0]->account_email, "Edit Request For Annual Final Report Project Approved", "<p>Dear ". $result[0]->account_fullname .", <br/><br/>Your Request For Editing A Annual Final Report Project Has Been Approved. </p>");
    ...
    public function reject_annual($id, $appid)
    {
        ...
        $this->email_model->send_email($result[0]->account_email, "Edit Request For Annual Final Report Project Rejected", "<p>Dear ". $result[0]->account_fullname .", <br/><br/>Your Request For Editing Annual Final Report Project Has Been Rejected Due to The Following Reason(s): " . $msg . "</p>");
    ...
    public function approve_incident_Exempt($id, $appid)
    {
        ...
        $this->email_model->send_email($result[0]->account_email, "Edit Request For Incident Accident Report For Exempt Dealings or Biohazardous Material Project Approved", "<p>Dear ". $result[0]->account_fullname .", <br/><br/>Your Request For Editing A Incident Accident Report For Exempt Dealings or Biohazardous Material project Has Been Approved. </p>");
    ...
    public function approve_minor($id, $appid)
    {
        ...
        $this->email_model->send_email($result[0]->account_email, "Edit Request For Minor Incident Accident Report For LMO Project Approved", "<p>Dear ". $result[0]->account_fullname .", <br/><br/>Your Request For Editing A Minor Incident Accident Report For LMO Project Has Been Approved. </p>");
    ...
    public function reject_minor($id, $appid)
    {
        ...
        $this->email_model->send_email($result[0]->account_email, "Edit Request For Minor Incident Accident Report For LMO Project Rejected", "<p>Dear ". $result[0]->account_fullname .", <br/><br/>Your Request For Editing Minor Incident Accident Report For LMO Project Has Been Rejected Due to The Following Reason(s): " . $msg . "</p>");
    ...
    public function approve_major($id, $appid)
    {
        ...
        $this->email_model->send_email($result[0]->account_email, "Edit Request For Major Incident Accident Report For LMO Project Approved", "<p>Dear ". $result[0]->account_fullname .", <br/><br/>Your Request For Editing A Major Incident Accident Report For LMO project Has Been Approved. </p>");
    ...
    public function reject_major($id, $appid)
    {
        ...
        $this->email_model->send_email($result[0]->account_email, "Edit Request For Major Incident Accident Report For LMO Project Rejected", "<p>Dear ". $result[0]->account_fullname .", <br/><br/>Your Request For Editing Major Incident Accident Report For LMO Project Has Been Rejected Due to The Following Reason(s): " . $msg . "</p>");
    ...
    public function approve_occupational($id, $appid)
    {
        ...
        $this->email_model->send_email($result[0]->account_email, "Edit Request For Occupational Disease or Exposure Project Approved", "<p>Dear ". $result[0]->account_fullname .", <br/><br/>Your Request For Editing A Occupational Disease or Exposure Project Has Been Approved. </p>");
    ...
    public function reject_occupational($id, $appid)
    {
        ...
        $this->email_model->send_email($result[0]->account_email, "Edit Request For Occupational Disease or Exposure Project Rejected", "<p>Dear ". $result[0]->account_fullname .", <br/><br/>Your Request For Editing MOccupational Disease or Exposure Project Has Been Rejected Due to The Following Reason(s): " . $msg . "</p>");
