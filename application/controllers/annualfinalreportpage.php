...
class annualfinalreportpage extends CI_Controller {
    ...
    public function index(){
            ...
            $data['announcement'] = $this->announcement_model->get_all_announcement( 'annualfinal' );
    ...
    public function delete_announcement($id) {
        ...
        $data['announcement'] = $this->announcement_model->remove_announcement($id, 'annualfinal' );
        # change the value inside ( ' HERE ' ) to call different announcement for different pages
        $data['announcement'] = $this->announcement_model->get_all_announcement( 'annualfinal' );
