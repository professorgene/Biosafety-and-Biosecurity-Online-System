    ...
    function __construct()
    {
		...
		public function index(){
            ...
            if (!isset($save) && !isset($submit)){
                ...
                //hirarc
                $ar7 = implode(',',$this->input->post('HIRARC_activity'));
                $ar8 = implode(',',$this->input->post('HIRARC_hazard'));
                $ar9 = implode(',',$this->input->post('HIRARC_effects'));
                $ar10 = implode(',',$this->input->post('HIRARC_risk_control'));
                $ar11 = implode(',',$this->input->post('HIRARC_LLH'));
                $ar12 = implode(',',$this->input->post('HIRARC_SEV'));
                $ar13 = implode(',',$this->input->post('HIRARC_RR'));
                $ar14 = implode(',',$this->input->post('HIRARC_control_measure'));
                $ar15 = implode(',',$this->input->post('HIRARC_PIC'));
                ...
                $hirarcData = array(
                    ...
                    'HIRARC_hazard' => $ar8,
                    'HIRARC_effects' => $ar9,
                    'HIRARC_risk_control' => $ar10,
                    'HIRARC_LLH' => $ar11,
                    'HIRARC_SEV' => $ar12,
                    'HIRARC_RR' => $ar13,
                    'HIRARC_control_measure' => $ar14,
                    'HIRARC_PIC' => $ar15,
                ...
                if($this->biohazard_model->insert_new_applicant_data($biohazardData) && $this->hirarc_model->insert_new_applicant_data($hirarcData) && $this->swp_model->insert_new_applicant_data($swpData))
                {
