...
class exportingofbioLMOpage extends CI_Controller {
	...
	function __construct()
    {
		...
		public function index(){
            ...
            $data['announcement'] = $this->announcement_model->get_all_announcement( 'exportBioLmo' );
    ...
    public function delete_announcement($id) {
        ...
        $data['announcement'] = $this->announcement_model->remove_announcement($id, 'exportBioLmo' );
        # change the value inside ( ' HERE ' ) to call different announcement for different pages
        $data['announcement'] = $this->announcement_model->get_all_announcement( 'exportBioLmo' );
